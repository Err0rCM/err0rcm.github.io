...
$$ P_A: 1/6 log_2(6/1) = 0.43 bits $$

$$ P_b:1/6 log_2(6/1) = 0.43 bits $$

$$ P_c:1/2 log_2(2/1) = 0.5 bits $$

$$ P_d:1/6 log_2(6/1) = 0.43 bits $$

张三得知`"有一半可能是C选项"`后的不确定性(熵)为 $1.79 bits$

$$ P_a+P_b+P_c+P_d = 1.79 bits $$

告诉张三`"有一半可能是C选项"`后提供的信息为 $2-1.79=0.21 bits$
...
[知乎:信息熵是什么？](https://www.zhihu.com/question/22178202)

[微信公众号:超智能体 信息论](https://mp.weixin.qq.com/s/toPBIMFPKG0FNzkKu2owfw)

[马猛飞,石乐义,魏东平,徐兴华.基于信息熵的分布式Web服务移动目标防御方案[J].计算机技术与发展,2020,30(10):131-136.](https://kns.cnki.net/kcms/detail/detail.aspx?filename=WJFZ202010024&dbcode=CJFQ&dbname=CJFD2020&v=f5iFxWNeOELznrq%mmd2BGTndyblA9BGrQdi6BASTgoipwWx5vvgdZDVsk9Y0pGb3T8Ra)
