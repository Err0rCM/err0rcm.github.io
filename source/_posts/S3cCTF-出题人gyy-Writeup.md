...
![web1](img/S3cCTF-出题人gyy-Writeup/20201122173122547.png)
...
![web2](img/S3cCTF-出题人gyy-Writeup/20201122174018834.png)
...
只有本地管理员才能访问本页面！
burp抓包修改即可
![web3](img/S3cCTF-出题人gyy-Writeup/20201122174702383.png)
...
![404](img/S3cCTF-出题人gyy-Writeup/20201122175207502.png)
因为界面是我自己写的假界面，特意写了个注释，由此想到重定向
直接在header里能看到flag
![flag](img/S3cCTF-出题人gyy-Writeup/20201122175439466.png)
拿去base64解一下即可获得flag

![base64](img/S3cCTF-出题人gyy-Writeup/20201122175814189.png)
----
...
![参数](img/S3cCTF-出题人gyy-Writeup/20201122180918644.png)
如果没有就会die退出
...
![calnum](img/S3cCTF-出题人gyy-Writeup/20201122181549903.png)
...
打开先看源代码
![vim](img/S3cCTF-出题人gyy-Writeup/20201122192109829.png)
Recover
Linux中，如果vim强退的话（ctrl+z）就会在目录下生成备份文件，如图所示
![ctrl+z](img/S3cCTF-出题人gyy-Writeup/20201122192350871.png)
而再vim编辑就会有如下提示
![re](img/S3cCTF-出题人gyy-Writeup/20201122192439588.png)
直接Recover恢复即可。

根据提示，访问./.index.php.swp。发现下载.swp文件
这里注意，备份文件是隐藏文件，文件名前面有个点
拿去linux系统恢复，可以发现
![flag1](img/S3cCTF-出题人gyy-Writeup/20201122192914742.png)
由此，flag分为多部分
...
![flag2](img/S3cCTF-出题人gyy-Writeup/20201122193206215.png)
机器人会告诉你剩下的，联想robots协议，访问./robots.txt
![robots](img/S3cCTF-出题人gyy-Writeup/20201122193300252.png)
可得flag在./r/o/b/o/a/t/s/1.php
![flag3](img/S3cCTF-出题人gyy-Writeup/20201122193344579.png)
将三段flag组合即可
...
后缀名限制
![php](img/S3cCTF-出题人gyy-Writeup/20201122194102133.png)
上传普通图片，被过滤
![gif](img/S3cCTF-出题人gyy-Writeup/20201122193716205.png)
抓包上传,原始如下
![post1](img/S3cCTF-出题人gyy-Writeup/20201122194225470.png)
修改如下
![post2](img/S3cCTF-出题人gyy-Writeup/20201122195020428.png)
...
![upload](img/S3cCTF-出题人gyy-Writeup/20201122195119845.png)
然后访问文件
![upload2](img/S3cCTF-出题人gyy-Writeup/20201122195246767.png)
发现代码被执行了，直接蚁剑连上get shell
![upload3](img/S3cCTF-出题人gyy-Writeup/20201122195418743.png)
根目录发现flag
![upload4](img/S3cCTF-出题人gyy-Writeup/20201122195438365.png)
...
打开直接给phpinfo，源代码有提示
![hint](img/S3cCTF-出题人gyy-Writeup/20201122195910990.png)
底部发现
![system](img/S3cCTF-出题人gyy-Writeup/20201122195933621.png)
其实是执行了`system("ls");`
![index](img/S3cCTF-出题人gyy-Writeup/20201122200056166.png)
...
![dom](img/S3cCTF-出题人gyy-Writeup/20201122200729886.png)
其实还可以利用写入一句话木马等操作。
...
![rfc](img/S3cCTF-出题人gyy-Writeup/20201122201134715.png)
访问`https://www.ietf.org/`
![rfc](img/S3cCTF-出题人gyy-Writeup/20201122201307663.png)
或者直接访问RFC文档搜索网站`https://www.rfc-editor.org/search/rfc_search.php`


![rfc](img/S3cCTF-出题人gyy-Writeup/20201122201725572.png)
截至2020年10月31日，一查
![rfc](img/S3cCTF-出题人gyy-Writeup/20201122201943714.png)
最新为RFC8940
这种东西最标准还是去官网查
...
2014
![2014](img/S3cCTF-出题人gyy-Writeup/20201122202110805.png)

##### 3. 本校校园卡上对应的教学楼是主校区的几号教学楼？

拿出来看看...百度地图打开，
![1](img/S3cCTF-出题人gyy-Writeup/20201122202320233.png)
全景地图
![1](img/S3cCTF-出题人gyy-Writeup/20201122202433684.png)
有点老，仔细观察地图，只有1教有那么大地方，2教3教都不会有那么大的中央空地![1](img/S3cCTF-出题人gyy-Writeup/20201122202751489.jfif)
good
...
原本考爆破的，后来干脆直接你们社工算了...
![id](img/S3cCTF-出题人gyy-Writeup/20201122203410982.png)
打开去掉disable标签
![id](img/S3cCTF-出题人gyy-Writeup/2020112220344579.png)
下面提示
![id](img/S3cCTF-出题人gyy-Writeup/20201122203500307.png)
...
ID:12019054018
![id](img/S3cCTF-出题人gyy-Writeup/20201122203854684.png)
...
![flag](img/S3cCTF-出题人gyy-Writeup/20201122204149398.png)
软件读文件
![flag](img/S3cCTF-出题人gyy-Writeup/20201122204353880.png)
拖出来打开就是flag
...
复制去二进制转字符，直接出答案
![man](img/S3cCTF-出题人gyy-Writeup/2020112220515011.png)
...
默认设置解密，直接出答案
![slient](img/S3cCTF-出题人gyy-Writeup/20201122205451153.png)
...
![00](img/S3cCTF-出题人gyy-Writeup/20201122210335385.png)
保存后解压只有副本那个文件可以保存，其他两个文件是真加密
![00](img/S3cCTF-出题人gyy-Writeup/20201122210502282.png)
根据明文攻击方法，将这个文件打包zip然后去题目再下一遍原文件,此时文件被修改，也可以改回去

用AZPR选择明文攻击即可

![在这里插入图片描述](img/S3cCTF-出题人gyy-Writeup/20201122210917960.png)
可以看到密钥被恢复了，不用找密码了，直接可以保存
![在这里插入图片描述](img/S3cCTF-出题人gyy-Writeup/20201122211504935.png)
保存文件，其实已经破解出来了
![在这里插入图片描述](img/S3cCTF-出题人gyy-Writeup/20201122210823677.png)
或者用rbkcrack也可以
直接打开flag.txt得flag